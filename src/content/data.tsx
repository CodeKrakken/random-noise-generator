...
const demoVoices = [
  {
    ...
    activeFrequencies:   [   65.41,    69.30,    73.42,    77.78,    82.41,    87.31,    92.50,    98.00,   103.83,   110.00,   116.54,   123.47,   130.81],
    restChance: 25,
    minLength: 0,
    maxLength: 100,
    minOffset: 0,
  ...
  },
  {
    ...
    activeFrequencies:   [  130.81,   138.59,   146.83,   155.56,   164.81,   174.61,   185.00,   196.00,   207.65,   220.00,   233.08,   246.94,   261.63],
    restChance: 0,
    minLength: 0,
    maxLength: 100,
    minOffset: 50,
    ...
    activeFrequencies:   [ 4186.01,  4434.92,  4698.63,  4978.03,  5274.04,  5587.65,  5919.91,  6271.93,  6644.88,  7040.00,  7458.62,  7902.13,  8372.02],
    restChance: 0,
    minLength: 25,
    maxLength: 100,
    minOffset: 50,
